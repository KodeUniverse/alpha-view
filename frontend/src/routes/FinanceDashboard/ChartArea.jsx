...
export default function ChartArea() {
    ...
    useEffect(() => {
        ...
        const fetchStockData = async () => {
            try {
                ...
                console.log(`Error fetching stock data from ${import.meta.env.API_URL}/stock-data/hist-ts/${symbol}/latest\n${e}`);
            }
        }
        fetchStockData();
    }, [symbol])
    return (
        <div className={styles["chart-container"]}>
            <input ref={inputValRef} type="text" placeholder="Enter ticker, symbol, etc." defaultValue={symbol} />
            <button style={{ height: "25px", width: "50px" }} onClick={handleStockSubmit}>Submit</button>
